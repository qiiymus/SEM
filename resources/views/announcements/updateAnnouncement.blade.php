                    ...
                    <table class="rounded-xl px-4 w-3/6">
                        <tbody >
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2"><input type="number" name="desc" class="form-control rounded-xl bg-gray-200 border border-slate-400" step=".01" required></td>
                            </tr>
                        </tbody>
                    </table>
                </table>
                    ...
                    <form action="{{ route('updateAnnouncement', $announcement->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="desc" id="desc" class="form-textarea rounded-md shadow-sm mt-1 block w-full"
                                rows="4" required>{{ old('desc', $announcement->desc) }}</textarea>
                            @error('desc')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
